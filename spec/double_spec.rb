...
RSpec.describe "Doubles" do
  ...
  it "leaf's branch returns expected length" do
    ...
    branch = double("branch is 4 feet", length: "4 feet")
    leaf = double("leaf belongs_to branch", branch: branch)
  ...
  it "leaf's branch's tree returns expected bark" do
    ...
    tree = double("tree has think and brown bark", bark: "thick and brown")
    branch = double("branch belongs_to tree", tree: tree)
    leaf = double("leaf belongs_to branch", branch: branch)
